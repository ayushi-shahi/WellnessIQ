...
def chat_with_assistant(
    ...
    if latest_trackers:
        latest = latest_trackers[0]
        context = f"\n\nUser's recent health data: Sleep: {latest.sleep_hours or 'N/A'} hours, Steps: {latest.steps or 'N/A'}, Calories: {latest.calories or 'N/A'}, Mood: {latest.mood_score or 'N/A'}/10, Stress: {latest.stress_level or 'N/A'}/10."
